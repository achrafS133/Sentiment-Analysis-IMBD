...
The goal is to classify reviews as \*\*positive\*\* or \*\*negative\*\* using Natural Language Processing (NLP) and machine learning techniques.
...
Some key visual outputs included in this project:
...
&nbsp; <img src="final\_model\_dashboard.png" width="600"/>
